    ...
    <div class="block orange" style="text-align: center;">
        ...
        <div class="row h3">
        	<div class="large-6 columns left">
        		<img src="<?php echo $ROOT ?>img/contact-sac.jpg" alt="Sacramento Office">
        		<p class="vcard">
					...
					:f <span class="fax">916.441.0571</span>
        		</p>
        	</div>
        	<div class="large-6 columns left">
        		<img src="<?php echo $ROOT ?>img/contact-sd.jpg" alt="San Diego Office">
        		<p class="vcard">
        ...
        <div class="row h3">
            ...
            <div class="large-6 columns left">
                <a href="http://move.meringcarson.com" class="socialicon blog">Blog Name</a>
                <a href="http://twitter.com/meringcarson" class="socialicon twitter">@meringcarson</a>
            </div>
            <div class="large-6 columns left">
                <a href="http://move.meringcarson.com" class="socialicon linkedin">/meringcarson</a>
